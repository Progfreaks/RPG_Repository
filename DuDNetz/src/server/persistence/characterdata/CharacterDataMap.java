...
public class CharacterDataMap implements Serializable,ICharacterDefs{
	...
	private static void loadFile() {
		try {
			...
			FileInputStream fIS = new FileInputStream("./resource/charactertable.dat");
			...
			System.out.println(" keine Datei exsistiert. wird 'charactertable.dat' erzeugt");
	...
	public void saveFile() {
		try {
			FileOutputStream fOS = new FileOutputStream("./resource/charactertable.dat");
