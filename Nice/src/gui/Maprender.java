...
public class Maprender {
	...
	public Maprender(DuD game, BackLayer backLayer, ButtonLayer buttonLayer){
		...
		backLayer.add(menue, BorderLayout.SOUTH);// Hinzuf�gen des Menuelayer, Layout unterer Bildschirmrand
		*/
		backLayer.addPanel(buttonLayer.getButtonLayer(), 0);//Hinzuf�gen des Buttonlayer
