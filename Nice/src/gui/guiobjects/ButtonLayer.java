...
public class ButtonLayer {
	...
	public void fillLayer(int index, int i, int s){
		...
		fieldSquares[i][s].setOpaque(true); addButton(fieldSquares[i][s]); disable(fieldSquares[i][s]); break;
	...
	public void setBlank(){
		buttonLayer.setBackground(Color.BLACK);
	}
